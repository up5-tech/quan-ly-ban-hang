...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                THÊM ĐƠN HÀNG <a class="fa  fa-bars" href=""></a>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Trang Chủ</a></li>
                <li><a href="<?php echo $url; ?>">Admin</a></li>
                <li class="active"><a>Thêm Đơn Hàng</a></li>
            </ol>
        </section>
        <!-- Main content -->
                                            ...
                                            <select>
                                                ...
                                                foreach ($_customer
                                                    ...
                                                    <option class="form-control"
                                                            value="<?php echo $customer['name']; ?>"><?php echo $customer['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </th>
                                        <th>Nhân Viên:
