...
<div class="">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                TẤT CẢ NHÂN VIÊN <a class="fa  fa-plus-square" href="<?php echo $url; ?>index.php/users/show_add_user" title="Thêm nhân viên"></a>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-hover" border="5">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>TÊN NHÂN VIÊN</th>
