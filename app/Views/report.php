                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <h3 class="widget-user-username">TieuCaHcmus</h3>
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
                                ...
                                <li><a href="#">Followers <span class="pull-right badge bg-red">999</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /.widget-user -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <h3 class="widget-user-username">PerterNguyen</h3>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <h3 class="widget-user-username">BinhThien</h3>
                            <h5 class="widget-user-desc">Developer</h5>
                        </div>
                        <div class="box-footer no-padding">
                            <ul class="nav nav-stacked">
