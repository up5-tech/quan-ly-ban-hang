...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <a class="fa fa-backward" href="<?php echo $url;?>index.php/products/view_all_product"></a> CẬP NHẬT SẢN PHẨM
            </h1>
            <ol class="breadcrumb">
                                ...
                                <form method="get"
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <td>
                                                <input  type="text" value="<?php echo $_product['quantity'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $_product['price_import'] ?>"
                                                   onkeypress=" return isNumberKey(event)"
                                                   class="form-control"
                                                   name="edit_price_import">
                                        </div>

                                        <div class="form-group">
                                            <label for="">Giá Bán</label>
                                            <input type="text" value="<?php echo $_product['price_export'] ?>"
                                                   onkeypress=" return isNumberKey(event)"
                                                   class="form-control"
                                                   name="edit_price_export">
                                        </div>

                                        <div class="form-group">
                                            <label for="">Ghi Chú</label>
                                            <input type="text" value="<?php echo $_product['note'] ?>"
                                                   class="form-control"
                                                   name="edit_note">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Ảnh</label>
                                            <input type="file" id="edit_name_img" name="edit_name_img">
